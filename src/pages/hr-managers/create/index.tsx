      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          <NumberInput
            ...
            formControlProps={{
              id: 'hr_manager_number',
              isInvalid: !!formik.errors?.hr_manager_number,
            }}
            name="hr_manager_number"
            error={formik.errors?.hr_manager_number}
            value={formik.values?.hr_manager_number}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('hr_manager_number', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
