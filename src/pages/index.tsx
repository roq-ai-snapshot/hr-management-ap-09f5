  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Management Application: Your gateway to streamlined human resources processes, enhancing efficiency, and driving business growth."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Management Application: Your gateway to streamlined human resources processes, enhancing efficiency, and driving business growth.`}
            </Text>
            <Box
